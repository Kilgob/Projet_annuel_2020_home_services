...
// afin d'empêcher de choisir un nouveau service et de pouvoir faire payer le bon montant
    ...
    if($servicePending['data'][0]['lb'] != NULL){
        if($_SESSION['data'][0]['cdabonement'] == 0){//si user n'a pas d'abonnement
            echo "<p>".t("vous avez une nouvelle facture")." : " . $servicePending['data'][0]['lb'] . $servicePending['data'][0]['numservice'] . "<br></p>";
        }
    ...
    echo "<p>".t("vous n'avez pas de nouvelles factures")." : " . $servicePending['data'][0]['lb'] . $servicePending['data'][0]['numservice'] . "<br></p>";
    }
