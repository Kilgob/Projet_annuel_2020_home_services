...
$requete = 'http://' . $_SESSION['ip_agence'] . '/intervention_deb_pre?iduser=' . $_SESSION['nmuser'];
...
<div class="container">
    <h1>Liste de mes interventions</h1>
    <ul class="list-group">
    <?php
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form id="interventions_statut" method="POST" action="upt_intervention_pre.php">
                        <input type="hidden" value="" name="idintervention" id="value_updt_id">
                        <input type="submit" value="Débuter l'intervention"/>
                    </form>
                </div>
            </div>
        </div>
